    ...
    <section id="about" className="section">
      <div className="container">
        ...
        <div className="about-content">
          <div>
            <p>
              Hello! I'm <span className="variable">John Doe</span>, a passionate full-stack developer with a strong 
            ...
            <br />
            <p>
              My journey in web development started <span className="number">5</span> years ago, and since then, 
              I've worked on various projects, from simple landing pages to complex enterprise applications.
            </p>
            <br />
            <p>
